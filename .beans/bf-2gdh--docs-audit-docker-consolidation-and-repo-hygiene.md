...
updated_at: 2026-08-01T14:41:42Z
---
...
- [ ] Task 3: fix the incorrect "there is no codecov.yml" claim in ARCHITECTURE.md, sweep links and env defaults
- [ ] Task 4: humanizer pass over the four public docs and the bf-vq0w body
